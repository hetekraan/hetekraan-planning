...
/**
 * Telefoon voor GHL `GET /contacts/search/duplicate?number=…` — zelfde E.164 als bij POST/PATCH.
 * Voorkomt missers wanneer GHL +316… heeft maar de invoer 06… / streepjes / spaties is.
 */
export function phoneForGhlDuplicateSearch(raw) {
