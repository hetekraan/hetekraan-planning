...
export async function triggerLiveRouteRecalculation({
  ...
  try {
    ...
    // createAppointment: volledige heroptimalisatie (zelfde pad als manual_button),
    // niet preserveOrder — nieuwe stop mag mid-route; pins via applyPinnedPositions.
    // Bewust NIET voor reschedule / complete / setInternalFixedStart / day_part_repair.
    const freeFullReoptimize = why === 'createAppointment';
